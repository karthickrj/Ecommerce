...
.bg{
    background-image: url("https://i.ytimg.com/vi/ZoOM7ccnd-8/maxresdefault.jpg");
...
<span class="icon bar"></span>
    ...
    <div class="navbar-header">
      <a class="navbar-brand" href="userHome">Foodie</a>
    </div>
...
<ul class="nav navbar-nav">
   ...
   <ul class="dropdown-menu">
     <li><a href="userList">veg</a></li>
      <li><a href="userList">Non-veg</a></li>
