...
<span class="icon bar"></span>
    ...
    <div class="navbar-header">
      <a class="navbar-brand" href="clienthome">Foodie</a>
    </div>
...
<ul class="nav navbar-nav">
 ...
 <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown">Food Category<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="household product ">NON-VEG</a></li>
